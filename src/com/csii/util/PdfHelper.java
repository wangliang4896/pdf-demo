...
import com.csii.util.PsdckPdfUtils;
...
public class PdfHelper {
	...
	public static String getPath(){
		return URLDecoder.decode(PdfHelper.class.getResource("").getPath());
	}
	
	public static String getPsdckPath(){
		return URLDecoder.decode(PsdckPdfUtils.class.getResource("").getPath());
	}
